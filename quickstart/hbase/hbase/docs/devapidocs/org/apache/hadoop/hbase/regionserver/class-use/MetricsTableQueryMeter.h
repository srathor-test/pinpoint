...
<title>Uses of Interface org.apache.hadoop.hbase.regionserver.MetricsTableQueryMeter (Apache HBase 1.4.13 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Interface org.apache.hadoop.hbase.regionserver.MetricsTableQueryMeter (Apache HBase 1.4.13 API)";
        }
    }
    catch(err) {
    }
...
<td class="colLast"><code><strong><a href="../../../../../../org/apache/hadoop/hbase/regionserver/MetricsTableQueryMeterImpl.html" title="class in org.apache.hadoop.hbase.regionserver">MetricsTableQueryMeterImpl</a></strong></code>
