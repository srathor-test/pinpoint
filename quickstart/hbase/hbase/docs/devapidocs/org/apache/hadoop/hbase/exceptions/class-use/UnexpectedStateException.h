...
<title>Uses of Class org.apache.hadoop.hbase.exceptions.UnexpectedStateException (Apache HBase 1.4.13 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.hadoop.hbase.exceptions.UnexpectedStateException (Apache HBase 1.4.13 API)";
        }
    }
    catch(err) {
    }
